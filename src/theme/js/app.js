...
/* ==========================================================================
	...
	let recomendationsSlider = $(".recomendations-slider");
...
/* ==========================================================================
	...
	function fileManagerHeight() {
		$('.files-manager').each(function(){
			...
			let paddings = parseInt($('.page-content').css('padding-top')) +
							parseInt($('.page-content').css('padding-bottom')) +
							parseInt(box.css('margin-bottom')) + 2;
...
/* ========================================================================== */
	...
	$('.control-item-header .caret-down, .control-item-header .text').on('click', function() {
		let content = $(this).closest('li').find('.control-item-content');
