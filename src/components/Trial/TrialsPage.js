      ...
      <div className="main-wrap">
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-border" data-dismiss="modal" onClick={this.ConfirmDelete} >Delete </button> 
        ...
        <div className="modal fade" id="compeleteModal" role="dialog">
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                  <button type="button" className="btn btn-border" onClick={this.ConfirmCompelete} data-dismiss="modal" >Complete </button> 
                  <button type="button" className="btn btn-border" data-dismiss="modal">Close</button>
              </div>
            </div>
          </div>
        ...
        <section id="container" className="container-wrap">
          <ul className="breadcrumb breadcrumb-simple">
            ...
            <li className="active">Manage Trials</li>
          </ul>
          <section className="container-fluid">
            <div id="toolbar">
              <h3 className="pull-left">Manage Trials</h3>
              <div className="pull-right right-head">
               <Link to="/trial" className="btn btn-border pull-left"> 
                <img src={require('../../assets/img/add-icon-white.png')} />Trial 
               </Link> 
              </div>
            </div>
            <div className="card manage-trial-search">
                  ...
                  <div className="col-md-3">
                    <div className="row">
                      ...
                      <button 
                        ...
                        <img src={require('../../assets/img/search-icon-white.png')} />Search
                      </button>
                      <button 
                        className="btn btn-border" 
                        id="reset" 
                        ...
                        <img src={require('../../assets/img/reset-icon-white.png')} />Reset
                      </button>
                    </div>  
                  </div>
                </div>
