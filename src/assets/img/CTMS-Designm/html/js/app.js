...
/* ==========================================================================
	...
	if (!("ontouchstart" in document.documentElement)) {
		...
		$('.modal.right .popup-content').jScrollPane(jScrollOptions);
		//$('.side-menu-addl').jScrollPane(jScrollOptions);
		$('.scrollable-block').jScrollPane(jScrollOptions);
		$('.dataTables_wrapper').jScrollPane(jScrollOptions);
		$('.box-popup').jScrollPane(jScrollOptions);
...
/* ==========================================================================
	...
	$('.header-search .site-header-search').each(function(){
		var parent = $(this),
			overlay = parent.find('.overlay');
...
//	$(this).addClass("pading-0");
	$( ".box-popup" ).parent( ".dropdown-popup" ).addClass("pading-0");
...
/* ==========================================================================
 ...
 $( '.drop-popup' ).click( function() {
	 	$("body").removeClass( 'drop-popup-open' );
		$("body").addClass( 'drop-popup-open' );
		
    });

/*
$('body').on("click touchstart", function(evt){    
	if(evt.target.className == 'modal-backdrop in') {
        $('.dropdown-popup').modal('hide');
 }
});*/
